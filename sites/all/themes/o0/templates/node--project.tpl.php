  ...
  <div class="node-content clearfix"<?php print $content_attributes; ?>>
    ...
    <div class="row">
      <div class="large-4 medium-5 columns">
        ...
        <?php if (!empty($content['field_project_image'])): ?>
          ...
          <?php else: ?>
            <div class="field field-name-field-project-image field-type-image show-for-small"><div class="field-items"><div class="field-item">
              <a href="<?php print image_style_url($variables['field_project_image__image_style__fullscreen'], $node->field_project_image['und'][0]['uri']); ?>" class="colorbox" rel="node-field-project-image">
        ...
        <?php if (!empty($content['field_project_r_organization'])): ?>
        ...
        <?php if (!empty($content['field_project_t_service'])): ?>
          <h4>My work on this project</h4>
          <?php print render($content['field_project_t_service']); ?>
        <?php endif; ?>

        <?php if (!empty($variables['field_project_t_person_exper__term'])): ?>
          <?php if ($variables['field_project_t_person_exper__term'] == 'Freelance web developer'): ?>
            <div class="field field-name-field-project-t-person-exper-descr field-type-text"><div class="field-items"><div class="field-item">
              <p>This project was completed as part of my freelance web development work.</p>
            </div></div></div>
          <?php endif; ?>
          <?php if ($variables['field_project_t_person_exper__term'] == 'Shervin'): ?>
            <div class="field field-name-field-project-t-person-exper-descr field-type-text"><div class="field-items"><div class="field-item">
              <p>This project was completed as part of my work as Lead Web Developer at Shervin Communications.</p>
            </div></div></div>
          <?php endif; ?>
          <?php if ($variables['field_project_t_person_exper__term'] == 'Wild ARC'): ?>
            <div class="field field-name-field-project-t-person-exper-descr field-type-text"><div class="field-items"><div class="field-item">
              <p>This project was completed as part of my volunteer work at the BC SPCA Wild ARC.</p>
            </div></div></div>
          <?php endif; ?>
          <?php if ($variables['field_project_t_person_exper__term'] == 'Freelance graphic designer'): ?>
            <div class="field field-name-field-project-t-person-exper-descr field-type-text"><div class="field-items"><div class="field-item">
      ...
      <div class="large-8 medium-7 columns">
        ...
        if (!empty($content['field_project_image_2'])) {
          foreach ($node->field_project_image_2['und'] as $key => $value) {
            $node_field_project_image_2[] = '<div class="hide field field-name-field-project-image-2 field-type-image thumbnail ' . $foundation_grid_column_classes . '"><div class="field-items"><div class="field-item"><a href="' . image_style_url('project_image_modal_fullscreen', $node->field_project_image_2['und'][$key]['uri']) . '" class="colorbox" rel="node-field-project-image" title="' . $node->field_project_image_2['und'][$key]['title'] . '"><img typeof="foaf:Image" src="' . image_style_url('project_image_2_node', $node->field_project_image_2['und'][$key]['uri']) . '" alt="' . $node->field_project_image_2['und'][$key]['alt'] . '" title="' . $node->field_project_image_2['und'][$key]['title'] . '" /></a></div></div></div>';
          }
        }
        if (!empty($content['field_project_image_mobile'])) {
          foreach ($node->field_project_image_mobile['und'] as $key => $value) {
            $node_field_project_image_2[] = '<div class="hide field field-name-field-project-image-mobile field-type-image thumbnail ' . $foundation_grid_column_classes . '"><div class="field-items"><div class="field-item"><a href="' . image_style_url('project_image_mobile_modal_fullscreen', $node->field_project_image_mobile['und'][$key]['uri']) . '" class="colorbox" rel="node-field-project-image" title="' . $node->field_project_image_mobile['und'][$key]['title'] . '"><img typeof="foaf:Image" src="' . image_style_url('project_image_mobile_2_node', $node->field_project_image_mobile['und'][$key]['uri']) . '" alt="' . $node->field_project_image_mobile['und'][$key]['alt'] . '" title="' . $node->field_project_image_mobile['und'][$key]['title'] . '" /></a></div></div></div>';
          }
        }
