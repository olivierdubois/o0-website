  ...
  <div class="node-content clearfix"<?php print $content_attributes; ?>>
    ...
    <?php if (!empty($content['field_person_skill'])): ?>
      ...
      <div class="field field-name-field-person-skill field-type-field-collection clearfix">
        <script type="text/javascript">
          ...
          var chart_person_skills_1__chartData = [
          ...
          AmCharts.ready(function() {
            var chart_person_skills_1__chart = new AmCharts.AmSerialChart();
            chart_person_skills_1__chart.dataProvider = chart_person_skills_1__chartData;
            chart_person_skills_1__chart.categoryField = "skill";
            chart_person_skills_1__chart.startDuration = 1;
            chart_person_skills_1__chart.creditsPosition = "top-right";

            var chart_person_skills_1__graph = new AmCharts.AmGraph();
            chart_person_skills_1__graph.valueField = "level";
            chart_person_skills_1__graph.type = "column";
            chart_person_skills_1__graph.lineColor = "rgb(135, 206, 235)";
            chart_person_skills_1__graph.lineAlpha = 0;
            chart_person_skills_1__graph.fillAlphas = 0.8;
            chart_person_skills_1__graph.balloonText = "[[category]]: <b>[[value]]</b>";
            chart_person_skills_1__chart.addGraph(chart_person_skills_1__graph);

            var chart_person_skills_1__categoryAxis = chart_person_skills_1__chart.categoryAxis;
            chart_person_skills_1__categoryAxis.autoGridCount  = false;
            chart_person_skills_1__categoryAxis.gridCount = chart_person_skills_1__chartData.length;
            chart_person_skills_1__categoryAxis.gridPosition = "start";
            chart_person_skills_1__categoryAxis.autoWrap = true;
            chart_person_skills_1__categoryAxis.labelRotation = 0;

            var chart_person_skills_1__valueAxis = new AmCharts.ValueAxis();
            chart_person_skills_1__valueAxis.minimum = 0;
            chart_person_skills_1__valueAxis.maximum = 100;
            chart_person_skills_1__valueAxis.unit = "%";
            chart_person_skills_1__valueAxis.autoGridCount = false;
            chart_person_skills_1__chart.addValueAxis(chart_person_skills_1__valueAxis);

            chart_person_skills_1__chart.write("chart-person-skills-1");
          });
        </script>
        <div id="chart-person-skills-1" class="chart chart-person-skills amcharts"></div>
      </div>
    <?php endif; ?>
    ...
    <?php if (!empty($content['field_person_skill_2'])): ?>
      ...
      <div class="field field-name-field-person-skill field-type-field-collection clearfix">
        <script type="text/javascript">
          // Build the array containing the data for the chart.
          var chart_person_skills_2__chartData = [
          ...
          // Build the chart.
          AmCharts.ready(function() {
            var chart_person_skills_2__chart = new AmCharts.AmSerialChart();
            chart_person_skills_2__chart.dataProvider = chart_person_skills_2__chartData;
            chart_person_skills_2__chart.categoryField = "skill";
            chart_person_skills_2__chart.startDuration = 1;
            chart_person_skills_2__chart.creditsPosition = "top-right";

            var chart_person_skills_2__graph = new AmCharts.AmGraph();
            chart_person_skills_2__graph.valueField = "level";
            chart_person_skills_2__graph.type = "column";
            chart_person_skills_2__graph.lineColor = "rgb(135, 206, 235)";
            chart_person_skills_2__graph.lineAlpha = 0;
            chart_person_skills_2__graph.fillAlphas = 0.8;
            chart_person_skills_2__graph.balloonText = "[[category]]: <b>[[value]]</b>";
            chart_person_skills_2__chart.addGraph(chart_person_skills_2__graph);

            var chart_person_skills_2__categoryAxis = chart_person_skills_2__chart.categoryAxis;
            chart_person_skills_2__categoryAxis.autoGridCount  = false;
            chart_person_skills_2__categoryAxis.gridCount = chart_person_skills_2__chartData.length;
            chart_person_skills_2__categoryAxis.gridPosition = "start";
            chart_person_skills_2__categoryAxis.autoWrap = true;
            chart_person_skills_2__categoryAxis.labelRotation = 0;

            var chart_person_skills_2__valueAxis = new AmCharts.ValueAxis();
            chart_person_skills_2__valueAxis.minimum = 0;
            chart_person_skills_2__valueAxis.maximum = 100;
            chart_person_skills_2__valueAxis.unit = "%";
            chart_person_skills_2__valueAxis.autoGridCount = false;
            chart_person_skills_2__chart.addValueAxis(chart_person_skills_2__valueAxis);

            chart_person_skills_2__chart.write("chart-person-skills-2");
          });
        </script>
        <div id="chart-person-skills-2" class="chart chart-person-skills amcharts"></div>
      </div>
    <?php endif; ?>
